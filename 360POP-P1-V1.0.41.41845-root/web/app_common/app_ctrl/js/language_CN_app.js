    ...
    HTML: {
        ...
        arp_oversee: {
            ...
            filter_arp: {
                ...
                filterArpTab: ["设备", "IP", "MAC", "来源", "接口",  "操作"],
                status: ["动态", "静态"],
                bindStatus: ["绑定", "取消绑定"],
                unknown: "未知",
...
//                }
        ...
        vpn: {
            ...
            js: {
                tabTitle: ["VPN客户端", "VPN客户端列表"],
                clientTabHead: ["序列号", "客户端类型", "服务器地址", "用户名", "密码", "内部端口","状态","操作"],
                clientTabBtn: ["添加", "删除", "修改", "操作"],
                success: "成功！",
                status: ["启用", "禁止"],
                dialog: "请确认断开连接？",
                dialog_confirm: "确定删除选中数据？",
                clientStatusTabHead: ["序列号", "客户端类型","用户名", "连接状态", "本地IP地址", "对端IP地址", "操作"],
                linkStr: ["连接", "断开"]
            }
        },
        oray_ddns: {
...
//                    setupBtn:"配置",
        ...
        safety_wireless: {
            ...
            safety_redirection: {
                html: {
                    ...
                    noticeSec: "如果回答错误，将会被安全路由当成蹭网嫌疑用户，通知管理员！",
                    title: "360安全路由",
        ...
        samba: {
            html: {
                samba_tips: "<p>温馨提示：开启Windows文件共享后，您可以在“这台电脑>网络”中访问存储设备中的共享数据;</p><p>您还可以通过在IE浏览器或文件地址栏中输入<span class=\"windows_path\">\"\\\\luyou.360.cn\"</span>(Windows用户)或<span class=\"mac_path\">\"smb\\\\luyou.360.cn\"</span>(MAC OS用户)访问共享数据。</p>",
                form_label: ["共享状态"],
                save_btn: "保存生效"
            },
            js: {
        ...
        dlna: {
            html: {
                dlna_tips: "<p>温馨提示：首先，您需要在连接路由器的设备（例如手机、平板电脑等）中安装支持DLNA的多媒体终端，然后，</p><p class=\"ti5\">开启多媒体共享，就可以在设备中播放存储设备中共享的图片、音乐、视频文件。</p>",
                form_label: ["共享状态"],
                save_btn: "保存生效"
            }
        },
        ...
        touch_link: {
            ...
            touch_switch: {
                html: {
                    ...
                    "step-introduce":["开启访客摩擦上网功能<br/>将手机连上360摩擦上网-xxxx","将连上网络的手机靠近路由器上方10厘米<br/>指示灯全亮3秒后，完成认证"],
                    bigger_btn: "立即开启"
                }
            },
            wireless_list: {
            ...
            js: {
                ...
                push_status_arr: [
                    {statestr: '轻轻摩擦路由器后，需要管理员确认后才能够连接上网', linkstr: "切换到无需认证模式"},
                ...
                mode_type: ["等待管理员验证", "通过验证未连接", "连接", "断开", "已被管理员拒绝"],
                wireless_list: [
