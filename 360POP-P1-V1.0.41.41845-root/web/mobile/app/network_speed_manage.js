    ...
    var defineObj = {
        ...
        getDevicesListFn: function (data) {
            ...
            for (var i = 0; i < dataDevicesList.length; i++) {
                ...
                dataDevicesListItem.os_type = me.getOsType(dataDevicesListItem.os_type);
        ...
        getDataComment: function (dataItem) {
            ...
            dataItem.name = dataItem.alias || dataItem.device_label || dataItem.name || L.unnamed_device;
            return dataItem;
        },
