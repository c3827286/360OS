...
var pptp_client = {
	...
	init_nav:function(){
        $("#pptp_client_nav dl").undelegate("dd","click").delegate("dd","click",function(){
	...
	paint_pptp_client_setup_list:function(data){
		...
		for(var i in data){
			...
			(function(p){
				$dd.unbind("hold tap doubletap  click").bind("hold tap doubletap  click",function(){
					me.pptp_client_fill_data(data[p]);
					me.bind_back_event("pptp_client_list");
				});
				$a.unbind("hold tap doubletap  click").bind("hold tap doubletap  click",function(e){
					e.stopPropagation();
