...
var anti_ddos = {
	...
	wanping_status:0,
	init_nav:function(){
        $(".anti_ddos_nav dl").undelegate("dd","click").delegate("dd","click",function(){
	...
	bind_btn_event:function(){
        $(".btn_normal_setting").unbind("click").bind("click",function(){
            me.save_anti_ddos_basic_step1(2);
        });
        $(".btn_enable_all").unbind("click").bind("click",function(){
            me.save_anti_ddos_basic_step1(1);
        });
        $(".btn_disable_all").unbind("click").bind("click",function(){
