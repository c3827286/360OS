...
language_M.CN = {
    ...
    SELECT: {
        ...
        wifi_wap_option: [
            ...
            {value: 0, txt: "无"},
            {value: 7, txt: "WPA2-PSK AES"},
            {value: 8, txt: "WPA/WPA2-PSK AES"}
        ],
        wan1_select_option: [
            {value: "auto", txt: "自动模式"},
    ...
    HTML: {
        ...
        router_info: {
            html: {
                ...
                router_name_info_a: "360安全路由",
                router_model: "处理器型号：",
                router_model_a: "RTL8196D",
                router_logo: "处理器品牌：",
                router_logo_a: "REALTEK",
                router_hz: "处理器主频：",
                router_hz_a: "620MHz",
                router_bone: "处理器架构：",
                router_bone_a: "MIPS",
                router_wifi_speed: "无线传输速率：",
                router_wifi_speed_a: "300Mbps",
                router_save_in: "内存：",
                router_save_in_a: "64MB",
                router_save_onoff: "闪存：",
                router_save_onoff_a: "8MB",
                online_info: "上网信息",
                wanIp: "外网IP地址：",
                wanMask: "子网掩码：",
                wanGm: "默认网关：",
        ...
        safety_wireless: {
            html: {
                "form-label": ["状态：", "密码保护问题：", "密码保护答案：", "未认证用户禁止访问路由器:", "未认证用户禁止访问有线电脑:", "全部状态："],
        ...
        samba:{
            html:{
                sambaTip:"温馨提示：开启Windows文件共享后，您可以在\"这台电脑>网络\"中访问存储设备中的共享数据；您还可以通过在IE浏览器或文件地址栏中输入\"\\\\luyou.360.com\"（Windows用户）或\"smb\\\\luyou.360.com\"（Mac用户）访问共享数据",
                shareTxt:"共享状态:"
            }
        },
        dlna:{
...
//        action: "init_password",
   ...
   /* ,
    developer_mode: {
        ...
        action: "init_wireless_advance_show",
        save: "wireless_advance_set",
        formData:"wireless_advance_frm"
    }*/
};//总的菜单项

//默认菜单项
var languageM_default_navMap = {
    network_speed_manage: {
        title: "网速管理",
        src: "./images/speedLimit.png",
        currentHtml: "network_speed_manage",
