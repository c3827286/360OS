...
function paint_pptp_client_setup_list(data){
	...
	var tab = new libTable(appHtml.pptpClientSetupList,new_data,1,10);
	print_table("pptp_client_setup_list",tab,[{type:'edit',name:'pptp_client_setup_modify',str:appCommonJS.btnTitle.edit},{type:'del',name:'pptp_client_setup_delete',str:appCommonJS.btnTitle.del}],false);
	nos.app.resizePage();
}
...
function init_pptp_client_status_list(data){
	...
	var tab = new libTable(appHtml.pptpClientStatusList,new_data,1,10);
	print_table("pptp_client_status_list",tab,null,false);
	nos.app.resizePage();
}
