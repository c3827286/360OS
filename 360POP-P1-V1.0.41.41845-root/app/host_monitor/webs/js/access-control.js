...
function initIpTitleTable(obj, data, member) {
    ...
    if (member == 'up_speed_qos') {
		...
		var name = data['alias'] || data['device_label'] || data['name'] || appCommonJS.other.unknownDevice;
...
function initTable(obj, n, member, m) {
    ...
    if (member == 'conn_count') {
        ...
        var showName = host_list_temp_info[n]['alias'] || host_list_temp_info[n]['device_label'] || host_list_temp_info[n]['name'] || appCommonJS.other.unknownDevice;
