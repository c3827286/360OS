...
function dataChangeTo_white(data) {
    ...
    for (var i in data) {
        ...
        tempObj.name = data[i].host_name || appCommonJS.other.unknownDevice;
...
function init_safety_white_tab(data) {
    ...
    var tab = new libTable(appHtml.white_list, new_data, 1, 10);
    /*    print_table("safety_white_tab", tab, [{
     type: 'link',
     name: 'safety_white_link',
     str:btnStr[0]
     }, {
     type: 'back',
     name: 'safety_white_back',
     str: btnStr[1]
     }, {
     type: 'atbl',
     name: 'safety_white_atbl',
     str: btnStr[2]
     }], false);*/
    print_table("safety_white_tab", tab, null, false);
    nos.app.resizePage();
}
...
function init_safety_black_tab(data) {
    ...
    var tab = new libTable(appHtml.black_list, new_data, 1, 10);
    print_table("safety_black_tab", tab, [
        {
            type: 'del',
            name: 'safety_black_del',
            str: appCommonJS.btnTitle.del
        },
        {
            type: 'ok',
            name: 'safety_black_atbl',
            str: appHtml.blackListBtn
        }
    ], false);
    nos.app.resizePage();
}
