 ...
 # GNU C (Realtek RSDK-4.4.7 Build 1471) version 4.4.7 (mips-linux-uclibc)
 #	compiled by GNU C version 4.4.7, GMP version 4.2.4, MPFR version 2.3.2.
 # GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
 # options passed:  -nostdinc
 # -I/home/lianlong/P1_POWER4S_PLUGIN/RT288x_SDK/source/linux-2.6.36.x/arch/rlx/include
 # -Iinclude -Iinclude/asm-rlx -Iarch/rlx/bsp/ -Iarch/rlx/
 # -I/home/lianlong/P1_POWER4S_PLUGIN/RT288x_SDK/source/linux-2.6.36.x/arch/rlx/include/asm/mach-generic
 # -imultilib 5281 -iprefix
 # /opt/tool/rtl/bin/../lib/gcc/mips-linux-uclibc/4.4.7/ -isysroot
 # /opt/tool/rtl -D__KERNEL__ -UMIPSEB -U_MIPSEB -U__MIPSEB -U__MIPSEB__
 # -UMIPSEL -U_MIPSEL -U__MIPSEL -U__MIPSEL__ -DMIPSEB -D_MIPSEB -D__MIPSEB
 # -D__MIPSEB__ -DVMLINUX_LOAD_ADDRESS=0x80000000 -DKBUILD_STR(s)=#s
 # -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
 # -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
 # /opt/tool/rtl/bin/../lib/gcc/mips-linux-uclibc/4.4.7/include -include
 # include/generated/autoconf.h -MD arch/rlx/kernel/.asm-offsets.s.d
 # arch/rlx/kernel/asm-offsets.c -G 0 -meb -march=5281
 # -mno-check-zero-division -mabi=32 -mno-abicalls -msoft-float -mplt
 # -mno-shared -auxbase-strip arch/rlx/kernel/asm-offsets.s -Os -Wall
 # -Wundef -Wstrict-prototypes -Wno-trigraphs
 # -Werror-implicit-function-declaration -Wno-format-security
 # -Wframe-larger-than=1024 -Wdeclaration-after-statement -Wno-pointer-sign
 # -ffix-bdsl -fuse-tls -fuse-uls -fno-strict-aliasing -fno-common
 # -fno-delete-null-pointer-checks -ffunction-sections -fno-pic
 # -ffreestanding -fomit-frame-pointer -fno-strict-overflow
 ...
 # -mgp32 -mgpopt -mlocal-sdata -mlong32 -mmemcpy -mno-mips16 -mno-mips3d
 # -mplt -msoft-float -msplit-addresses -muclibc

 # Compiler executable checksum: f483715aada62e1a0e53ce8093353a41
...
->THREAD_BVADDR 792 offsetof(struct task_struct, thread.cp0_badvaddr)	 #
 # 0 "" 2
 # 143 "arch/rlx/kernel/asm-offsets.c" 1
	
->THREAD_BUADDR 796 offsetof(struct task_struct, thread.cp0_baduaddr)	 #
 # 0 "" 2
 # 144 "arch/rlx/kernel/asm-offsets.c" 1
	
->THREAD_ECODE 800 offsetof(struct task_struct, thread.error_code)	 #
 # 0 "" 2
 # 145 "arch/rlx/kernel/asm-offsets.c" 1
	
->THREAD_TRAPNO 804 offsetof(struct task_struct, thread.trap_no)	 #
 # 0 "" 2
 # 146 "arch/rlx/kernel/asm-offsets.c" 1
...
->_PTRS_PER_PTE 1024 PTRS_PER_PTE	 #
 # 0 "" 2
 # 180 "arch/rlx/kernel/asm-offsets.c" 1
...
->SC_PC 8 offsetof(struct sigcontext, sc_pc)	 #
 # 0 "" 2
 # 190 "arch/rlx/kernel/asm-offsets.c" 1
...
->_SIGXFSZ 31 SIGXFSZ	 #
 # 0 "" 2
 # 228 "arch/rlx/kernel/asm-offsets.c" 1
...
->IC_IRQ_CPUSTAT_T 32 sizeof(irq_cpustat_t)	 #
 # 0 "" 2
 # 236 "arch/rlx/kernel/asm-offsets.c" 1
...
->
 ...
 #NO_APP
	...
	.ident	"GCC: (Realtek RSDK-4.4.7 Build 1471) 4.4.7"
