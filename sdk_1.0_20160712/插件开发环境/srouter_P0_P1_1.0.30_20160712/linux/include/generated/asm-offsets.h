...
#define THREAD_BVADDR 792 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 796 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 800 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAPNO 804 /* offsetof(struct task_struct, thread.trap_no)	 # */
