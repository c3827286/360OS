...
#define RX_OFFSET	2
#endif
//reduce the skb data len 4k => 2k
#define MBUF_LEN	1540
...
#define SMP_LOCK_ETH_CACHE(__x__)			spin_lock_irqsave(&lock_spi, (__x__))
#define SMP_UNLOCK_ETH_CACHE(__x__) 		spin_unlock_irqrestore(&lock_spi, (__x__))
#else
